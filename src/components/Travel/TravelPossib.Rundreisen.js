...
import RundreisenAfrika from './TravelPossib.Rundreisen.Afrika'
import RundreisenArktisIsland from './TravelPossib.Rundreisen.ArktisIsland'
import RundreisenAsien from './TravelPossib.Rundreisen.Asien'
import RundreisenEuropa from './TravelPossib.Rundreisen.Europa'
import RundreisenIndischSubKont from './TravelPossib.Rundreisen.IndischSubKont'
import RundreisenIndischOzean from './TravelPossib.Rundreisen.IndischOzean'
import RundreisenMittelAmerika from './TravelPossib.Rundreisen.MittelAmerika'
import RundreisenNordAmerika from './TravelPossib.Rundreisen.NordAmerika'
import RundreisenOrient from './TravelPossib.Rundreisen.Orient'
import RundreisenSuedAmerika from './TravelPossib.Rundreisen.SuedAmerika'
import RundreisenSuedPazifik from './TravelPossib.Rundreisen.SuedPazifik'
...
export default function SliderComponent() {
  const sliderItems = [
    {
      ...
      imgSrc: 'https://www.designreisen.de/fileadmin/_processed_/9/c/csm_welt_fe5c7099cf.jpg',
  ...
  return (
    <Box sx={{ position: 'relative', paddingBottom: '105px' }}>
      ...
      <RundreisenAfrika />
      <RundreisenArktisIsland />
      <RundreisenAsien />
      <RundreisenEuropa />
      <RundreisenIndischSubKont />
      <RundreisenIndischOzean />
      <RundreisenMittelAmerika />
      <RundreisenNordAmerika />
      <RundreisenOrient />
      <RundreisenSuedAmerika />
      <RundreisenSuedPazifik />
